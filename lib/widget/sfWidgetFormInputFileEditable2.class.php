 ...
 */
class sfWidgetFormInputFileEditable2 extends sfWidgetFormInputFileEditable
{
  /**
   * Constructor.
   *
  ...
  protected function getFileAsTag($attributes)
  {
    ...
    else
    {
        ...
        {
            if($this->getOption('file_src') !== '/uploads/documentos/') 
            {
                echo link_to('Ver Arquivo', $this->getOption('file_src'), array('target' => '_blank'));
                return true;
            }
        }
    }
