...
abstract class BaseTbInscricaoForm extends BaseFormDoctrine
{
  public function setup()
  {
    $this->setWidgets(array(
      ...
      'boleto'               => new sfWidgetFormTextarea(),
      'pago'                 => new sfWidgetFormInputCheckbox(),
      'id_tipo_isencao'      => new sfWidgetFormDoctrineChoice(array('model' => $this->getRelatedModelName('TbTipoIsencao'), 'add_empty' => false)),
      'isento'               => new sfWidgetFormInputCheckbox(),
      'vaga_deficiente'      => new sfWidgetFormInputCheckbox(),
      'id_idioma'            => new sfWidgetFormDoctrineChoice(array('model' => $this->getRelatedModelName('TbIdioma'), 'add_empty' => false)),
    ...
    $this->setValidators(array(
      ...
      'boleto'               => new sfValidatorString(array('required' => false)),
      'pago'                 => new sfValidatorBoolean(array('required' => false)),
      'id_tipo_isencao'      => new sfValidatorDoctrineChoice(array('model' => $this->getRelatedModelName('TbTipoIsencao'))),
      'isento'               => new sfValidatorBoolean(array('required' => false)),
      'vaga_deficiente'      => new sfValidatorBoolean(array('required' => false)),
