...
abstract class BaseTbCandidatoForm extends BaseFormDoctrine
{
  public function setup()
  {
    $this->setWidgets(array(
      ...
      'estado_nascimento' => new sfWidgetFormDoctrineChoice(array('model' => $this->getRelatedModelName('TbEstado'), 'add_empty' => false)),
      ...
      'id_cidade'         => new sfWidgetFormInputText(),
    ...
    $this->setValidators(array(
      ...
      'estado_nascimento' => new sfValidatorDoctrineChoice(array('model' => $this->getRelatedModelName('TbEstado'))),
      'cidade_nascimento' => new sfValidatorString(array('max_length' => 255)),
      ...
      'id_cidade'         => new sfValidatorString(array('max_length' => 255, 'required' => false)),
      'id_estado'         => new sfValidatorInteger(array('required' => false)),
