...
abstract class BaseTbInscricaoFormFilter extends BaseFormFilterDoctrine
{
  public function setup()
  {
    $this->setWidgets(array(
      ...
      'id_tipo_isencao'      => new sfWidgetFormDoctrineChoice(array('choices' => array('' => 'yes or no', 1 => 'yes', 0 => 'no'), 'model' => $this->getRelatedModelName('TbTipoIsencao'), 'add_empty' => true)),
      'isento'               => new sfWidgetFormChoice(array('choices' => array('' => 'yes or no', 1 => 'yes', 0 => 'no'))),
    ...
    $this->setValidators(array(
      ...
      'id_tipo_isencao'      => new sfValidatorDoctrineChoice(array('required' => false, 'model' => $this->getRelatedModelName('TbTipoIsencao'), 'column' => 'id')),
      'isento'               => new sfValidatorChoice(array('required' => false, 'choices' => array('', 1, 0))),
