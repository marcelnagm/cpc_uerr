...
abstract class BaseTbInscricaoFormFilter extends BaseFormFilterDoctrine
{
  public function setup()
  {
    $this->setWidgets(array(
      ...
      'id_idioma'            => new sfWidgetFormFilterInput(array('with_empty' => false)),
    ...
    $this->setValidators(array(
      ...
      'boleto'               => new sfValidatorSchemaFilter('text', new sfValidatorInteger(array('required' => false))),
      ...
      'id_idioma'            => new sfValidatorSchemaFilter('text', new sfValidatorInteger(array('required' => false))),
