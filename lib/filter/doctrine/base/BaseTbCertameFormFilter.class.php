...
abstract class BaseTbCertameFormFilter extends BaseFormFilterDoctrine
{
  public function setup()
  {
    $this->setWidgets(array(
      ...
      'tem_redacao'           => new sfWidgetFormChoice(array('choices' => array('' => 'yes or no', 1 => 'yes', 0 => 'no'))),
      'tem_idioma'            => new sfWidgetFormChoice(array('choices' => array('' => 'yes or no', 1 => 'yes', 0 => 'no'))),
    ...
    $this->setValidators(array(
      ...
      'tem_redacao'           => new sfValidatorChoice(array('required' => false, 'choices' => array('', 1, 0))),
      'tem_idioma'            => new sfValidatorChoice(array('required' => false, 'choices' => array('', 1, 0))),
