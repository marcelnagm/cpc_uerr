...
/**
 * TbLotacaoProva filter form base class.
 *
 * @package    uerr
 * @subpackage filter
 * @author     Marcel Nagm
 ...
 */
abstract class BaseTbLotacaoProvaFormFilter extends BaseFormFilterDoctrine
{
  public function setup()
  {
    ...
    $this->widgetSchema->setNameFormat('tb_lotacao_prova_filters[%s]');
