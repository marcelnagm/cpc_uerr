...
/**
 * OfferDiscipline filter form base class.
 *
 * @package    uerr
 * @subpackage filter
 ...
 */
abstract class BaseOfferDisciplineFormFilter extends BaseFormFilterDoctrine
{
  public function setup()
  {
    ...
    $this->widgetSchema->setNameFormat('offer_discipline_filters[%s]');
