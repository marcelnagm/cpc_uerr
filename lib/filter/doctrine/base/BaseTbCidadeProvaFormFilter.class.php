...
/**
 * TbCidadeProva filter form base class.
 *
 * @package    uerr
 * @subpackage filter
 * @author     Marcel Nagm
 ...
 */
abstract class BaseTbCidadeProvaFormFilter extends BaseFormFilterDoctrine
{
  public function setup()
  {
    ...
    $this->widgetSchema->setNameFormat('tb_cidade_prova_filters[%s]');
